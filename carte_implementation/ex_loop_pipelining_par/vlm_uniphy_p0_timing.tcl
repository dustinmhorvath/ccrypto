...
set ISI(addresscmd_setup) 0.154
set ISI(addresscmd_hold) 0.154
set ISI(DQ) 0.08
set ISI(DQS) 0.0060

# Board skews
set board(abs_max_CK_delay) 0.3189
set board(abs_max_DQS_delay) 0.3515
set board(minCK_DQS_skew) -0.0301
set board(maxCK_DQS_skew) 0.0301
set board(tpd_inter_DIMM) 0.0217
set board(intra_DQS_group_skew) 0.0091
set board(inter_DQS_group_skew) 0.0601
set board(DQ_DQS_skew) -0.3051
set board(intra_addr_ctrl_skew) 0.3201
set board(addresscmd_CK_skew) -0.3201
